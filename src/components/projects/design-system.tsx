  ...
  return (
    <main className="px-4 mx-auto pt-32 space-y-12">
      <div className="mb-8 flex flex-col gap-4">
        <div className="font-bold text-4xl">{t("Projects.first.name")}</div>
        <div className="text-light">{t("Projects.first.summary")}</div>
      </div>
      <div className="w-full border-y border-foreground/20 py-1 flex justify-end">
        ...
        >
          ...
          >
            <LinkIcon className="group-hover:text-firstary" />
        ...
        <div className="space-y-12">
          <div className="flex flex-col space-y-14">
            <div id="description" className="flex flex-col gap-6">
              ...
              <p className="text-light">{t("Projects.first.description")}</p>
            </div>
